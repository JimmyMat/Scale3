...
void CScale3MainWin::OnOpening1SetCommState (void)
{
   ...
   _stprintf_s(szTemp1, STANDARD_STRING, _T("%d,%s,%d,%d"),
      ulBaudRates[m_sCurrentBaudRateIndex],
      szParity2[m_sCurrentParityIndex],
      sDataBits[m_sCurrentDataBitsIndex],
      iTemp1);
...
void CScale3MainWin::OnSelchangePortList (void)
{
   ...
   _stprintf_s(m_ComPorts[m_sCurrentPortIndex].Parity, 16, _T("%s"), szParity[m_sCurrentParityIndex]);
...
void CScale3MainWin::OutputProperties (void)
{
   ...
   m_StructLB.ResetContent ();
   i = 0;
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.wPacketLength);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.wPacketVersion);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwServiceMask);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwReserved1);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwMaxTxQueue);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwMaxRxQueue);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.dwMaxBaud);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwProvSubType);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.dwProvCapabilities);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.dwSettableParams);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.dwSettableBaud);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.wSettableData);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = 0x%X"), COMMPROPMembers[i++], m_CurrentCommProp.wSettableStopParity);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwCurrentTxQueue);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwCurrentRxQueue);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwProvSpec1);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMPROPMembers[i++], m_CurrentCommProp.dwProvSpec2);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %s"), COMMPROPMembers[i++], m_CurrentCommProp.wcProvChar);
   m_StructLB.AddString (szTemp1);
...
void CScale3MainWin::OutputCommState (void)
{
   ...
   m_StructLB.ResetContent ();
   i = 0;
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.DCBlength);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.BaudRate);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fBinary);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fParity);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fOutxCtsFlow);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fOutxDsrFlow);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fDtrControl);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fDsrSensitivity);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fTXContinueOnXoff);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fOutX);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fInX);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fErrorChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fNull);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fRtsControl);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fAbortOnError);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.fDummy2);
   m_StructLB.AddString (szTemp1);
   ...
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.XonLim);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.XoffLim);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.ByteSize);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.Parity);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.StopBits);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.XonChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.XoffChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.ErrorChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.EofChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.EvtChar);
   m_StructLB.AddString (szTemp1);
   _stprintf_s (szTemp1, 128, _T("%s = %d"), DCBMembers[i++], m_dcbCurrentDCB.wReserved1);
   m_StructLB.AddString (szTemp1);
...
void CScale3MainWin::OutputCommTimeouts (void)
{
   ...
   m_StructLB.ResetContent ();
   i = 0;
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMTIMEOUTSMembers[i++], m_CurrentCommTimeouts.ReadIntervalTimeout);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMTIMEOUTSMembers[i++], m_CurrentCommTimeouts.ReadTotalTimeoutMultiplier);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMTIMEOUTSMembers[i++], m_CurrentCommTimeouts.ReadTotalTimeoutConstant);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMTIMEOUTSMembers[i++], m_CurrentCommTimeouts.WriteTotalTimeoutMultiplier);
   m_StructLB.AddString (szTemp1);
   _stprintf_s(szTemp1, 128, _T("%s = %d"), COMMTIMEOUTSMembers[i++], m_CurrentCommTimeouts.WriteTotalTimeoutConstant);
   m_StructLB.AddString (szTemp1);
